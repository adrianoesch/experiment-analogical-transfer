var instructions = {
  ...
  task :      '<h2>Instructions</h2><p>Thank you very much for taking part in our experiment! \
              ...
              <script>$(".nameDivs").on("dragstart",Experiment.d.dragstart);$(".relationDivs").on("dragstart",Experiment.d.dragstart);$(".menui").on("drop",Experiment.d.drop);$(".menui").on("dragover",Experiment.d.dragover);$(".menui").on("dragleave",Experiment.d.dragleave);$(".inputi").on("drop",Experiment.d.drop);$(".inputi").on("dragover",Experiment.d.dragover);$(".inputi").on("dragleave",Experiment.d.dragleave);</script>\
