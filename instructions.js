var instructions = {
  ...
  task :      '<h2>Instructions</h2><p>Thank you very much for taking part in our experiment! \
              ...
              <script>$(".nameDivs").on("dragstart",function(ev){Experiment.d.dragstart(ev)});$(".relationDivs").on("dragstart",function(ev){Experiment.d.dragstart(ev)});$(".menui").on("drop",function(ev){Experiment.d.drop(ev)});$(".menui").on("dragover",function(ev){Experiment.d.dragover(ev)});$(".menui").on("dragleave",function(ev){Experiment.d.dragleave(ev)});$(".inputi").on("drop",function(ev){Experiment.d.drop(ev)});$(".inputi").on("dragover",function(ev){Experiment.d.dragover(ev)});$(".inputi").on("dragleave",function(ev){Experiment.d.dragleave(ev)});</script>\
              <p style="">When you are done with arranging objects, there will be a "Next" button to continue to the subsequent story. \
