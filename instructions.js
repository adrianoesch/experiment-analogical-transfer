var instructions = {
  ...
  task :      '<h2>Instructions</h2><p>Thank you very much for taking part in our experiment! \
              ...
              You can select names and relations with drag & drop and arrange each statement \
              ...
              relation "crashed" into the relation field the and the name "Krati" into the second name container, \
              you arrive at the correct solution.</p>\
              <p>If you changed your mind or made an error, just drag the item back into the menu container and choose \
