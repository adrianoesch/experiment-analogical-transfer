var instructions = {
  ...
  task :      '<h2>Instructions</h2><p>Thank you very much for taking part in our experiment! \
              ...
              another name. This example is dragable.</p>\
              <style>#content{width:800px;position:relative;}#menu{ border:solid 1px black;height:370px;}.menui{  width:150px;  height:280px;}.wrapMenu{  padding:0 50px;  float:left;}#menubox{margin:20px 0px 0px 130px;}#names, #name1, #name2{  background-color:rgb(230,230,230);}#relations, #relation{  background-color:rgb(200,200,200);}#names,#relations {  padding:10px;}#input{ width:800px; position:relative;  top:30px;  float:left; margin-bottom:60px;} .inputi{  width:190px;  padding:10px;  height:30px;}#inputbox{  font-size:16px;  position:relative;  border:1px solid black;  height:120px; padding:00px 50px;}.wrapInput{  float:left;  margin:20px 10px;}.relationDivs,.nameDivs{  font-size:13px;  font-family:arial;  height:20px;  border-radius: 3px;  margin:3px;  padding:0px 0px 5px 5px;}.nameDivs{  background-color: rgba(0,0,0,0.2);}.relationDivs {  background-color: rgba(0,0,0,0.2);}#nextbutton{  position:relative;  margin-top:30px;  float:right;  padding:10px;  border-radius: 5px;  width:80px;  text-align:center;  background-color: rgba(0,0,0,0.7);  color:rgb(230,230,230)}#nextbutton:hover{  background-color: rgb(255,20,20);  color: black;}#errormessage{  color:rgb(250,50,50);  text-align:center; font-size:15px;}</style><div id="content">Menu:  <div id="menu">    <div id="menubox">      <div class="wrapMenu">Names:<div id="names" class="menui" ondrop="d.drop(event)" ondragover="d.allowDrop(event)"><div class="nameDivs" id="name_0" ondragstart="d.drag(event)" draggable="true">Hize</div><div class="nameDivs" id="name_1" ondragstart="d.drag(event)" draggable="true">Lyde</div><div class="nameDivs" id="name_2" ondragstart="d.drag(event)" draggable="true">Rove</div><div class="nameDivs" id="name_3" ondragstart="d.drag(event)" draggable="true">Uvman</div><div class="nameDivs" id="name_4" ondragstart="d.drag(event)" draggable="true">Ofpoz</div><div class="nameDivs" id="name_5" ondragstart="d.drag(event)" draggable="true">Zimob</div></div></div>      <div class="wrapMenu">Relations:<div id="relations" class="menui" ondrop="d.drop(event)" ondragover="d.allowDrop(event)"><div class="relationDivs" id="relation_0" ondragstart="d.drag(event)" draggable="true">invents</div><div class="relationDivs" id="relation_1" ondragstart="d.drag(event)" draggable="true">is invades</div><div class="relationDivs" id="relation_2" ondragstart="d.drag(event)" draggable="true">breaches</div><div class="relationDivs" id="relation_3" ondragstart="d.drag(event)" draggable="true">is loosing</div><div class="relationDivs" id="relation_4" ondragstart="d.drag(event)" draggable="true">hurts</div><div class="relationDivs" id="relation_5" ondragstart="d.drag(event)" draggable="true">introduces</div></div></div>  </div>  </div>  <div id="input">Input: <strong>Statement <span id="statementNr">1</span></strong> <span id="errormessage" style="margin-left:15px;"></span>    <div id="inputbox">      <div class="wrapInput">Name:<div id="name1" class="inputi" ondrop="d.drop(event)" ondragover="d.allowDrop(event)"></div></div>      <div class="wrapInput">Relation:<div id="relation" class="inputi" ondrop="d.drop(event)" ondragover="d.allowDrop(event)"></div></div>  <div class="wrapInput">Name:<div id="name2" class="inputi" ondrop="d.drop(event)" ondragover="d.allowDrop(event)"></div></div>    </div>  </div></div><script>var d = {  drag : function(ev) {    ev.dataTransfer.setData("text", ev.target.id);    ev.dataTransfer.setData("class", ev.target.className);  },  drop : function(ev) {    ev.preventDefault();    var data = ev.dataTransfer.getData("text");    var classMatch = ev.dataTransfer.getData("class").slice(0,4)==ev.target.id.slice(0,4);    var emptyOrBackDrop = (ev.target.innerHTML=="" || ev.target.className=="menui");    if ( classMatch && emptyOrBackDrop){      ev.target.appendChild(document.getElementById(data));    }  },  allowDrop : function(ev) {    var classMatch = ev.dataTransfer.getData("class").slice(0,4)==ev.target.id.slice(0,4);    if (classMatch && (ev.target.innerHTML=="" || ev.target.className=="menui")){      ev.preventDefault();    };  },};</script>\
              <p>When you are done with arranging objects, there will be a "Next" button to continue to the subsequent story. \
              New statements will appear thereafter.</p>\
              <p>Press the right arrow key to continue to the experiment.</p>\
              ',
