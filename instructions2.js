var instructions = {
  welcome :   '<p>To run this experiment we need launch into fullscreen mode. \
  ...
  task :      '<h2>Instructions</h2><p>Thank you very much for taking part in our experiment!</p>\
              ...
              at first those three statements will be presented statement by statement. Each statement will be presented for \
              fixed amount of time before the next statement is presented.</p>\
  ...
  repetitionClosed : '<p>Did you notice repeating elements between the stories during the experiment?<br>\
  ...
  analogyClosed : '<p>Did you notice the any repeating analog/causal structure during the experiment? \
